	...
	<body>
		...
		<div class="panel panel-default col-lg-12">
			...
			<ul class="nav navbar-nav navbar-center">
				...
				<li><g:link class="list btn btn-primary colortitle colorblack" action="index">Gestio Hroario "Evento"</g:link></li>
			...
			<ul class="property-list horarioEvento">
				...
				<li class="fieldcontain">
					<span id="horaInicio-label" class="property-label"><g:message code="horarioEvento.horaInicio.label" default="Hora Inicio" /></span>
						...
						<span class="property-value" aria-labelledby="horaInicio-label"><g:fieldValue bean="${horarioEventoInstance}" field="horaInicio"/></span>
				...
				<li class="fieldcontain">
					<span id="horafin-label" class="property-label"><g:message code="horarioEvento.horafin.label" default="Horafin" /></span>
						...
						<span class="property-value" aria-labelledby="horafin-label"><g:fieldValue bean="${horarioEventoInstance}" field="horafin"/></span>
