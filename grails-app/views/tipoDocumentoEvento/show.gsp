...
<html>
	...
	<body>
		...
		<div id="show-tipoDocumentoEvento" class="content scaffold-show" role="main">
			...
			<ul class="property-list tipoDocumentoEvento">
				...
				<li class="fieldcontain">
					<span id="tipoDoumentoEvento-label" class="property-label"><g:message code="tipoDocumentoEvento.tipoDoumentoEvento.label" default="Tipo Doumento Evento" /></span>
					
						<span class="property-value" aria-labelledby="tipoDoumentoEvento-label"><g:fieldValue bean="${tipoDocumentoEventoInstance}" field="tipoDoumentoEvento"/></span>
				...
				<li class="fieldcontain">
					<span id="documentoEvento-label" class="property-label"><g:message code="tipoDocumentoEvento.documentoEvento.label" default="Documento Evento" /></span>
					
						<g:each in="${tipoDocumentoEventoInstance.documentoEvento}" var="d">
						<span class="property-value" aria-labelledby="documentoEvento-label"><g:link controller="documentoEvento" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
			...
			<g:form url="[resource:tipoDocumentoEventoInstance, action:'delete']" method="DELETE">
