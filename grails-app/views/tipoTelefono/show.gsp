		...
		<div id="show-tipoTelefono" class="content scaffold-show" role="main">
			...
			<ul class="property-list tipoTelefono">
				...
				<li class="fieldcontain">
					<span id="vigente-label" class="property-label"><g:message code="tipoTelefono.vigente.label" default="Vigente" /></span>
					
						<span class="property-value" aria-labelledby="vigente-label"><g:formatBoolean boolean="${tipoTelefonoInstance?.vigente}" /></span>
				...
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="tipoTelefono.descripcion.label" default="Descripcion" /></span>
					
						<span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${tipoTelefonoInstance}" field="descripcion"/></span>
				...
				<li class="fieldcontain">
					<span id="telefonos-label" class="property-label"><g:message code="tipoTelefono.telefonos.label" default="Telefonos" /></span>
						...
						<span class="property-value" aria-labelledby="telefonos-label"><g:link controller="telefonoInstituto" action="show" id="${t.id}">${t?.encodeAsHTML()}</g:link></span>
						</g:each>
			...
			<g:form url="[resource:tipoTelefonoInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit btn btn-primary colortitle colorblack" action="edit" resource="${tipoTelefonoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					&nbsp;
