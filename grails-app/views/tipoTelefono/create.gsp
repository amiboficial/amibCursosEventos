...
<g:set var="entityName"
	value="${message(code: 'tipoTelefono.label', default: 'TipoTelefono')}" />
		...
		<div class="panel panel-default col-lg-12">
			...
			<ul class="nav navbar-nav" role="navigation">
				...
				<li><g:link class="list btn btn-primary colortitle colorblack"
						action="index">Gestión tipo telefono</g:link></li>
			</ul>
			<br>
		</div>
	</fieldset>
	...
	<div class="panel panel-default col-lg-12">
		<div class="panel-heading">
			<div class="widgetTitle">
				...
				<g:form url="[resource:tipoTelefonoInstance, action:'save']">
					<fieldset class="form">
