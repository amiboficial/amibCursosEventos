	...
	<body>
		...
		<div class="panel panel-default col-lg-12">
			...
			<ul class="nav navbar-nav" role="vavBar">
				...
				<li><g:link class="list btn btn-primary colortitle colorblack" action="index">Gestión de Tipos de Curso</g:link></li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;</li>
				<li><g:link class="create btn btn-primary colortitle colorblack" action="create">Crear Tipos de Cursos</g:link></li>
			</ul><br>
		</div>
		</fieldset>
		...
		<div class="panel panel-default col-lg1-2">
			<div class="panel-heading">
				<div class="widgetTitle">
					<div id="edit-tipoCurso" class="content scaffold-edit" role="main">
						<h1>
			...
			<g:form url="[resource:tipoCursoInstance, action:'update']"
				method="PUT">
				<g:hiddenField name="version" value="${tipoCursoInstance?.version}" />
				<fieldset class="form">
