	...
	<body>
		...
		<div class="panel panel-default col-lg-12">
			...
			<ul class="nav navbar-nav" role="vavBar">
				...
				<li><g:link class="list btn btn-primary colortitle colorblack" action="index">Gestión Estatus "Evento"</g:link></li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;</li>
		...
		<div id="edit-cambioStatusEvento" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:cambioStatusEventoInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${cambioStatusEventoInstance?.version}" />
				<fieldset class="form">
