		...
		<div class="panel panel-default col-lg-12">
			...
			<ul class="nav navbar-nav" role="vavBar">
				<li><g:link class="list btn btn-primary colortitle colorblack" action="index">Gestión de Teléfonos de Institutos</g:link></li>
					<li>&nbsp;&nbsp;&nbsp;&nbsp;</li>
				<li><g:link class="create btn btn-primary colortitle colorblack" action="create">Crear Teléfonos de Institutos</g:link></li>
			</ul><br>
		</div>
		</fieldset>
		...
		<div class="panel panel-default col-lg-12">
			<div class="panel-heading">
				<div class="widgetTitle">
					<div id="edit-telefonoInstituto" class="content scaffold-edit"
						role="main">
						<h1>
							Editar Teléfonos de Institutos
						</h1>
			...
			<g:form url="[resource:telefonoInstitutoInstance, action:'update']"
				method="PUT">
				<g:hiddenField name="version"
					value="${telefonoInstitutoInstance?.version}" />
				<fieldset class="form">
